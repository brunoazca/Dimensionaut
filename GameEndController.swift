...
class GameEndController: UIViewController, SCNPhysicsContactDelegate {
@ObservedObject var appRouter: AppRouter
    // create a new scene
let scene = SCNScene(named: "GameEnd.scn")!
let scnView:SCNView
...
override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
    ...
    box.physicsBody?.applyForce(SCNVector3(Float.random(in: -1...1), Float.random(in: -1...1), Float.random(in: -1...1)), asImpulse: true)
}
